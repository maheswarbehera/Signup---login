...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sqlexist = "SELECT *FROM `signup`WHERE `email` ='$email'";
    ...
    if ($numexist > 0) {
        ...
        if (($password == $cpassword)) {
            ...
            $sql = "INSERT INTO `signup` (`Name`, `Email`, `Password`, `Date`) VALUES ('$name', '$email', '$password', current_timestamp())";
                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-1">
                                    ...
                                    <img src="https://cdn-lite.ip2location.com/img/sign-up.png" class="img-fluid" alt="Sample image">
